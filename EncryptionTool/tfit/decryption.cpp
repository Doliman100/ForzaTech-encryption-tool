...
Decryption<Rounds>::Decryption(std::array<uint8_t, 16> &previous, std::span<const std::array<std::array<uint8_t, 4>, 4>, Rounds> keys, std::array<std::array<std::array<std::array<uint8_t, 4>, 256>, 16>, Rounds> &tables)
  : TFIT<Rounds>(previous, keys, tables) {

}

// FH5: 0000000145511A60
template<size_t Rounds>
void Decryption<Rounds>::RoundB(std::array<uint8_t, 16> &data, const std::array<std::array<uint8_t, 4>, 4> &key, std::array<std::array<std::array<uint8_t, 4>, 256>, 16> &table) {
...
// FH5: 0000000145509FD0
template<size_t Rounds>
void Decryption<Rounds>::Update(std::array<uint8_t, 16> &src, std::array<uint8_t, 16> &dst) {
